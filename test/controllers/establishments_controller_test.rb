...
class EstablishmentsControllerTest < ActionController::TestCase
  ...
  test "should create establishment" do
    assert_difference('Establishment.count') do
      post :create, establishment: { email: @establishment.email, password: @establishment.password, tel: @establishment.tel }
    end
  ...
  test "should update establishment" do
    patch :update, id: @establishment, establishment: { email: @establishment.email, password: @establishment.password, tel: @establishment.tel }
    assert_redirected_to establishment_path(assigns(:establishment))
  end
